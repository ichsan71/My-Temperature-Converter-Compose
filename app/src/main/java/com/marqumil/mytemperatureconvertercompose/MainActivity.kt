package com.marqumil.mytemperatureconvertercompose
...
import com.marqumil.mytemperatureconvertercompose.ui.theme.MyTemperatureConverterComposeTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            MyTemperatureConverterComposeTheme {
